...
- Deployment shall perform source update, dependency install, backend build, database bootstrap, and frontend build before replacing the PM2 process.
...
- Unit tests cover same-server isolation, missing/duplicate/unsafe targets, existing and missing databases, duplicate-create races, sanitized failures, and connection closure.
